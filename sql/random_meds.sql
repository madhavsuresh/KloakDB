...
insert into medications (medication, patient_id, year, month, dosage, route, timestamp_, site) select 'aspirin', 0, i,i,i,i,to_timestamp(i)::date, i  from generate_series(1,1000) s(i);
