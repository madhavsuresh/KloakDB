DROP TABLE IF EXISTS dem_ex, diag_ex, vit_ex, meds_ex, hd_cohort, meds_ex_filter;
...
SELECT * INTO meds_ex_filter FROM (SELECT * FROM meds_ex WHERE medication ILIKE '%aspirin%' AND dosage LIKE '%325%') t; ---AND medication ILIKE '%aspirin%') t;
