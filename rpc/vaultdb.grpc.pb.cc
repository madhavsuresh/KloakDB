...
DataOwner::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Generalize_(DataOwner_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SendTable_(DataOwner_method_names[6], ::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_RepartitionStepOne_(DataOwner_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RepartitionStepTwo_(DataOwner_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CoalesceTables_(DataOwner_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
