...
public:
    ...
    std::vector<std::shared_ptr<const ::vaultdb::TableID>> RepartitionStepOne(::vaultdb::TableID& tid);
    ...
    std::shared_ptr<const ::vaultdb::TableID> CoalesceTables(std::vector<std::shared_ptr<const ::vaultdb::TableID>>& tables);
