...
HonestBrokerImpl::HonestBrokerImpl(HonestBrokerPrivate *p) { this->p = p; }

::grpc::Status
HonestBrokerImpl::NumHosts(::grpc::ServerContext *context,
...
::grpc::Status HonestBrokerImpl::GetControlFlowColumn(
