 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status KAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::vaultdb::KAggregateResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>> AsyncKAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>>(AsyncKAggregateRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>> PrepareAsyncKAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>>(PrepareAsyncKAggregateRaw(context, request, cq));
    }
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>* AsyncKAggregateRaw(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::vaultdb::KAggregateResponse>* PrepareAsyncKAggregateRaw(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status KAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::vaultdb::KAggregateResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>> AsyncKAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>>(AsyncKAggregateRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>> PrepareAsyncKAggregate(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>>(PrepareAsyncKAggregateRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>* AsyncKAggregateRaw(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::vaultdb::KAggregateResponse>* PrepareAsyncKAggregateRaw(::grpc::ClientContext* context, const ::vaultdb::KAggregateRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_KAggregate_;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status KAggregate(::grpc::ServerContext* context, const ::vaultdb::KAggregateRequest* request, ::vaultdb::KAggregateResponse* response);
  ...
  template <class BaseClass>
  class WithAsyncMethod_KAggregate : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithAsyncMethod_KAggregate() {
      ::grpc::Service::MarkMethodAsync(5);
    }
    ~WithAsyncMethod_KAggregate() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status KAggregate(::grpc::ServerContext* context, const ::vaultdb::KAggregateRequest* request, ::vaultdb::KAggregateResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestKAggregate(::grpc::ServerContext* context, ::vaultdb::KAggregateRequest* request, ::grpc::ServerAsyncResponseWriter< ::vaultdb::KAggregateResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithGenericMethod_KAggregate : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithGenericMethod_KAggregate() {
      ::grpc::Service::MarkMethodGeneric(5);
    }
    ~WithGenericMethod_KAggregate() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status KAggregate(::grpc::ServerContext* context, const ::vaultdb::KAggregateRequest* request, ::vaultdb::KAggregateResponse* response) override {
  ...
  template <class BaseClass>
  class WithRawMethod_KAggregate : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithRawMethod_KAggregate() {
      ::grpc::Service::MarkMethodRaw(5);
    }
    ~WithRawMethod_KAggregate() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status KAggregate(::grpc::ServerContext* context, const ::vaultdb::KAggregateRequest* request, ::vaultdb::KAggregateResponse* response) override {
    ...
    void RequestKAggregate(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_KAggregate : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithStreamedUnaryMethod_KAggregate() {
      ::grpc::Service::MarkMethodStreamed(5,
        new ::grpc::internal::StreamedUnaryHandler< ::vaultdb::KAggregateRequest, ::vaultdb::KAggregateResponse>(std::bind(&WithStreamedUnaryMethod_KAggregate<BaseClass>::StreamedKAggregate, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_KAggregate() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status KAggregate(::grpc::ServerContext* context, const ::vaultdb::KAggregateRequest* request, ::vaultdb::KAggregateResponse* response) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedKAggregate(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::vaultdb::KAggregateRequest,::vaultdb::KAggregateResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_DBMSQuery<WithStreamedUnaryMethod_GetPeerHosts<WithStreamedUnaryMethod_KFilter<WithStreamedUnaryMethod_KJoin<WithStreamedUnaryMethod_KSort<WithStreamedUnaryMethod_KAggregate<WithStreamedUnaryMethod_Generalize<WithStreamedUnaryMethod_RepartitionStepOne<WithStreamedUnaryMethod_RepartitionStepTwo<WithStreamedUnaryMethod_CoalesceTables<Service > > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
